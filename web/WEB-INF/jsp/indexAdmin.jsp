            ...
            <div class="container"> <!-- Container -->
                ...
                <div class="row">
                    <div class="portfolio-items">
                        ...
                        <!--<div class="col-sm-6 col-md-3 col-lg-3 app">
                            <div class="portfolio-item">
                                <div class="hover-bg"> <a href="gestionarEvaluacionParaMonitorConsultar.htm">Gestionar evaluación para monitor (Consultar)</a>
                                    <div class="hover-text">
                                        <h4>Gestionar evaluación para monitor</h4>
                                        <small>Consultar</small>
                                        <div class="clearfix"></div>
                                    </div>
                                    <img src="<c:url value="/assets/img/portfolio/02.jpg"/>" class="img-responsive" alt="Consultar"> </a> </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3 col-lg-3 web">
                            <div class="portfolio-item">
                                <div class="hover-bg"> <a  href="gestionarEvaluacionParaMonitorCrear.htm">Gestionar evaluación para monitor (Crear)</a><br>
                                    <div class="hover-text">
                                        <h4>Gestionar evaluación para monitor</h4>
                                        <small>Crear</small>
                                        <div class="clearfix"></div>
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3 web">
                            <div class="portfolio-item">
                                <div class="hover-bg"> <a href="gestionarEvaluacionParaMonitorEditar.htm">Gestionar evaluación para monitor (Editar)</a><br>
                                    <div class="hover-text">
                                        <h4>Gestionar evaluación para monitor</h4>
                                        <small>Editar</small>
                                        <div class="clearfix"></div>
